...
fn big_multiple_sender() {
    ...
    let proto_config = Config::default();
    // proto_config.broadcast.optimization_threshold = (read_var("OPTIM", 7) as u16).into();
    // proto_config.membership.shuffle_interval = Duration::from_secs(5);
    ...
    let avg = simulator.report_round_average().mean;
    eprintln!(
